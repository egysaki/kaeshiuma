  ...
  class CourseInfo
    ...
    def self.course_defined(course)
      ...
      if course =~ /^東京芝$/
        ...
        @image_path = @image_path + 'niigata-dirt-'
        @name = '新潟 ダート'
      elsif course =~ /^小倉芝$/
        @info = {'1000': "平坦と下りのみのコースの為スピードが出やすい。 \n コース幅も広く内も詰まりにくいため逃げ・先行馬が有利。開催後半は芝がかなり傷むため、外が有利になる。",
                 '1200': "コースの最後部からのスタートになるためスピードが出やすくテンの3ハロンは非常に速い。3~4コーナーも下り坂の為スピードに加えてコーナリングも重要となる。 \n 基本的には逃げ・先行馬が有利だが開催後半なり、馬場が荒れて前半が速くなりすぎた際は差し馬が台頭することもある。",
                 '1700': "1コーナーまでの距離が短いため先行争いが激しくなりやすく、オーバーペース気味になると後半は苦しくなる。 \n 基本は先行馬が有利となる。外枠は外々を回されることになるが、芝が傷んでくると有利になる。",
                 '1800': "1コーナーまでの距離が近く、その後上りが続くためラップは速くなりにくい。そのため前残りしやすくなる。 \n 開催前半は特に内枠の先行馬が有利な傾向。",
                 '2000': "極端なハイペースになることは少ないが、直線が長く、1800mよりペースは速くなる。 \n 3コーナーあたりでペースアップしやすく、ここで先行争いが激しくなることもある。クラスが上がって点が速くなると差し、追い込みも決まるが、3歳未勝利、古馬500万は小倉のセオリー通りに先行馬が有利。",
                 '2600': "下り坂スタートだが長丁場のせいかペースは平均~スローになりやすい。 \n 軽い小倉の芝でもスタミナが重要で、基本は先行抜け出し。コーナーを多く回るため外枠は距離をロスしやすい。"
                }
        @image_path = @image_path + 'kokura-turf-'
        @name = '小倉 芝'
      elsif course =~ /^小倉ダート$/
        @info = {'1000': "緩い下り坂かつスパイラルカーブの為スピードが落ちにくい。先行争いは激しくなるが、逃げ馬が圧倒的に有利。スタート、スピード優先で逃げ・先行馬が一気になだれ込むパターンが多い。",
                 '1700': "スタート直後からポジション取りが激しくなるため前半のペースが速くなる。馬がバテやすく、最後の直線では上がり勝負にはならないため、4コーナーで前にいた馬が有利。 \n 向う上面でのマクリも決まりやすい。",
                 '2400': "1700m同様、流れが速いため瞬発力勝負にはなりにくい。マクリが決まりやすく、4コーナーで好位につけていないと厳しい。"
                }
        @image_path = @image_path + 'kokura-dirt-'
        @name = '小倉 ダート'
      end
    end
